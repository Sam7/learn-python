...
- `src/curriculum/` contains the typed Stage 0–11 curriculum outline from `docs/curriculum-01.md`: 12 stages and 109 micro-lessons. Stages 0–3 (34 lessons) are fully available; later lessons remain structured as `coming-soon` data until authored and tested.
